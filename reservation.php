          ...
          <div class="card-body">
            <form id="reservationForm">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="degree" placeholder="Enter degree/profession">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <div class="custom-control custom-checkbox">
                      <input class="custom-control-input" type="checkbox" id="termsCheck">
              ...
              <div class="row mt-4">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="signature" placeholder="Type your full name">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
              ...
              <div class="row mt-4 no-print">
                <div class="col-md-12">
                  <button type="button" class="btn btn-primary" id="submitBtn">Submit Form</button>
